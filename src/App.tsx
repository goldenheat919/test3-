...
import { charactersToNodes, relationsToEdges, filterBySearch, filterByRelationType } from './utils/graphTransform';
...
function WuxiaGraph() {
  ...
  const [activeRelationTypes, setActiveRelationTypes] = useState<RelationType[]>([
    RT.MASTER_APPRENTICE,
    RT.CHIVALROUS,
    RT.SWORN_BROTHER,
  ]);
